...
export const testDaten: ProtokollPaket[] = [
  // === Projekt 1: B123 Ausbau Musterstrasse — Protokoll 4 ===
  {
    ...
    Protokollelemente: [
      { Id: 'e-4-01', ProtokollId: 'prot-001a', Position: '1.1', Positionstitel: 'Baugrubensicherung Achse A', Positionstext: 'Verbau kontrollieren', Thema: 'Tiefbau', Status: 20, Termin: '2026-02-28T00:00:00', VerantwortlicherOid: 'adr-011', VerantwortlicherId: '50001', VerantwortlicherName: 'Adler Anton', Bemerkung: 'Erledigt', Erinnerung: false, Wert: 0, Verweise: [], MobileErfassung: { ...mob } },
      { Id: 'e-4-02', ProtokollId: 'prot-001a', Position: '1.2', Positionstitel: 'Wasserhaltung prüfen', Positionstext: 'Pumpensumpf und Abfluss kontrollieren', Thema: 'Tiefbau', Status: 20, Termin: '2026-02-28T00:00:00', VerantwortlicherOid: 'adr-012', VerantwortlicherId: '50002', VerantwortlicherName: 'Bauer Bernd', Bemerkung: 'OK', Erinnerung: false, Wert: 0, Verweise: [], MobileErfassung: { ...mob } },
      { Id: 'e-4-03', ProtokollId: 'prot-001a', Position: '2.1', Positionstitel: 'Fehlende Absturzsicherung', Positionstext: 'Geländer an Treppe Gebäude B fehlt', Thema: 'Mangel', Status: 25, Termin: '2026-03-05T00:00:00', VerantwortlicherOid: 'adr-010', VerantwortlicherId: '10010', VerantwortlicherName: 'GSD Software mbH', Bemerkung: 'Geländer montiert', Erinnerung: false, Wert: 0, Verweise: [], MobileErfassung: { ...mob } },
    ],
  },
  // === Projekt 1: B123 Ausbau Musterstrasse — Protokoll 5 ===
  {
    ...
    Protokollelemente: [
      { Id: 'e-5-01', ProtokollId: 'prot-001b', Position: '1.1', Positionstitel: '', Positionstext: 'Trasse herstellen, Bodenaushub und Leitungsverlegung gemäß Plan. Abschnitt 1+00 bis 1+50.', Thema: 'Tiefbau', Status: 10, Termin: '2026-03-16T00:00:00', VerantwortlicherOid: 'adr-011', VerantwortlicherId: '50001', VerantwortlicherName: 'Adler Anton', Bemerkung: '', Erinnerung: false, Wert: 0, Verweise: ['e-4-01'], MobileErfassung: { ...mob } },
      { Id: 'e-5-02', ProtokollId: 'prot-001b', Position: '1.2', Positionstitel: '', Positionstext: 'Verdichtungsprüfung nach Verfüllung durchführen.', Thema: 'Tiefbau', Status: 0, Termin: '2026-03-20T00:00:00', VerantwortlicherOid: 'adr-012', VerantwortlicherId: '50002', VerantwortlicherName: 'Bauer Bernd', Bemerkung: '', Erinnerung: true, Wert: 0, Verweise: [], MobileErfassung: { ...mob } },
      { Id: 'e-5-03', ProtokollId: 'prot-001b', Position: '2.1', Positionstitel: '', Positionstext: 'Schachtabdeckung nicht bündig Achse 1+35, Austausch erforderlich.', Thema: 'Mangel', Status: 11, Termin: '2026-03-18T00:00:00', VerantwortlicherOid: 'adr-010', VerantwortlicherId: '10010', VerantwortlicherName: 'GSD Software mbH', Bemerkung: 'Erstmals festgestellt am 09.03.2026', Erinnerung: false, Wert: 0, Verweise: [], MobileErfassung: { ...mob } },
      { Id: 'e-5-04', ProtokollId: 'prot-001b', Position: '2.2', Positionstitel: '', Positionstext: 'Haarriss in Bodenplatte Gebäude C, ca. 2m Länge. Gutachter hinzuziehen.', Thema: 'Mangel', Status: 11, Termin: '2026-03-25T00:00:00', VerantwortlicherOid: 'adr-012', VerantwortlicherId: '50002', VerantwortlicherName: 'Bauer Bernd', Bemerkung: '', Erinnerung: true, Wert: 2500.0, Verweise: [], MobileErfassung: { ...mob } },
      { Id: 'e-5-05', ProtokollId: 'prot-001b', Position: '3.1', Positionstitel: '', Positionstext: 'Absperrungen und Beschilderung kontrollieren.', Thema: 'Allgemein', Status: 20, Termin: '2026-03-10T00:00:00', VerantwortlicherOid: 'adr-011', VerantwortlicherId: '50001', VerantwortlicherName: 'Adler Anton', Bemerkung: 'Erledigt - alles in Ordnung.', Erinnerung: false, Wert: 0, Verweise: [], MobileErfassung: { ...mob, GeoLat: 50.3245, GeoLon: 11.285, GeoAccuracy: 5, GeoText: '50.3245, 11.285 (5 m)' } },
      { Id: 'e-5-06', ProtokollId: 'prot-001b', Position: '3.2', Positionstitel: '', Positionstext: 'Sicherheitsunterweisung für 3 neue MA der Fa. Bauer durchführen.', Thema: 'Info', Status: 17, Termin: '2026-03-09T00:00:00', VerantwortlicherOid: 'adr-010', VerantwortlicherId: '10010', VerantwortlicherName: 'GSD Software mbH', Bemerkung: 'Durchgeführt am 09.03.', Erinnerung: false, Wert: 0, Verweise: [], MobileErfassung: { ...mob } },
    ],
  },
  // === Projekt 2: K45 Sanierung Hauptstrasse — Protokoll 2 ===
  {
    ...
    Protokollelemente: [
      { Id: 'e-2-01', ProtokollId: 'prot-002a', Position: '1.1', Positionstitel: '', Positionstext: 'Fenster EG einbauen und abdichten.', Thema: 'Hochbau', Status: 10, Termin: '2026-03-12T00:00:00', VerantwortlicherOid: 'adr-021', VerantwortlicherId: '20002', VerantwortlicherName: 'Weber Klaus', Bemerkung: '', Erinnerung: false, Wert: 0, Verweise: [], MobileErfassung: { ...mob } },
      { Id: 'e-2-02', ProtokollId: 'prot-002a', Position: '1.2', Positionstitel: '', Positionstext: 'Estrich im OG einbringen, Trocknungszeit beachten.', Thema: 'Hochbau', Status: 19, Termin: '2026-03-15T00:00:00', VerantwortlicherOid: 'adr-020', VerantwortlicherId: '20001', VerantwortlicherName: 'Müller GmbH', Bemerkung: 'Freigabe erteilt', Erinnerung: false, Wert: 0, Verweise: [], MobileErfassung: { ...mob } },
      { Id: 'e-2-03', ProtokollId: 'prot-002a', Position: '2.1', Positionstitel: '', Positionstext: 'Kabeltrasse Keller falsch montiert, Neuverlegung nötig.', Thema: 'Mangel', Status: 11, Termin: '2026-03-10T00:00:00', VerantwortlicherOid: 'adr-022', VerantwortlicherId: '20003', VerantwortlicherName: 'Schneider Eva', Bemerkung: '', Erinnerung: false, Wert: 800, Verweise: [], MobileErfassung: { ...mob } },
    ],
  },
];
