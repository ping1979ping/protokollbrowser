...
// ============================================================================
// PING, 07.04.2026, CP (ClaudeCode)
//
// Scannt den Ordner K:\Sonstige\Docuframe-Exchange\data\dfimport\ nach
// progrp*.json, liest jede Datei, ruft PINGProtGrpImpJSON( JsonText, Err )
// auf und verschiebt erfolgreich verarbeitete Dateien nach dfimport\done\.
// Fehlschlaege bleiben in dfimport\ liegen und werden nach dfimport\import.log
// geschrieben.
//
// Einstieg fuer DOCUframe-Scheduler oder manuellen Aufruf.
// ============================================================================
...
INT PINGProtGrpImportBatch_Hub( HDIALOG Dialog, DBOBJECT &Object )
    ...
    WHILE( Finder.GetNext( Status ) )
        ...
        // Unterverzeichnisse ueberspringen (sollten bei progrp*.json nicht matchen,
        // aber Sicherheitsnetz)
        IF( !FileIsDir( FilePath ) )
            ...
            TimeStr = EditFormatDateTime( tNow );
